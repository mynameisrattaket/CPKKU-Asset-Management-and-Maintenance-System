...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('asset_main', function (Blueprint $table) {
            ...
            $table->date('asset_deteriorated_stop');
            $table->string('asset_type', 255);
            $table->string('asset_comment', 255);
            $table->string('asset_how', 255);
            $table->string('asset_company', 255);
            $table->string('asset_company_address', 255);
            $table->string('asset_type_sub', 255);
            $table->string('asset_type_main', 255);
            $table->string('asset_revenue', 255);
            $table->string('asset_img', 255);
