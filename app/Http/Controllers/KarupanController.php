...
class KarupanController extends Controller
{
    ...
    { 
        ...
        $data = [
            ...
            'deteriorated_total' => $request->deteriorated_total,
            'scrap_price' => $request->scrap_price,
            'deteriorated_account' => $request->deteriorated_account,
            'deteriorated' => $request->deteriorated,
            'deteriorated_at' => $request->deteriorated_at,
            ...
            'deteriorated_price' => $request->deteriorated_price,
            'asset_price_account' => $request->asset_price_account,
            'asset_account' => $request->asset_account,
            'deteriorated_total_account' => $request->deteriorated_total_account,
            'asset_live'=> $request->asset_live,
            'deteriorated_end' => $request->deteriorated_end
        ];
