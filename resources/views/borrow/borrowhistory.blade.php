...
<script>
    ...
    columnDefs: [
        { targets: [0], searchable: false },  // ไอดีไม่สามารถค้นหาได้
        { targets: [1], searchable: true },   // หมายเลขครุภัณฑ์สามารถค้นหาได้
        { targets: [2], searchable: true }    // ชื่อครุภัณฑ์สามารถค้นหาได้
    ],
    language: {
        search: "🔍ค้นหา: ",
