...
@section('title', 'การแจ้งซ่อมที่กำลังดำเนินการ')

@section('contentitle')
    <h4 class="page-title">การแจ้งซ่อมที่กำลังดำเนินการ</h4>
@endsection

@section('conten')
    <div class="col-3 text-end mb-2 mt-2"></div>
    <table id="repairProgressTable" class="table table-bordered mb-0">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="{{ route('updateRepairStatus', $repair->request_detail_id) }}">
                                    ...
                                    <div class="mb-3">
                                        <label for="requestTime{{ $repair->request_detail_id }}" class="form-label">วันเวลาที่แจ้ง</label>
